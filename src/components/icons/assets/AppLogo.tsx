...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="200.39" height="112.97" viewBox="0 0 200.39 112.97">
...
export default function AppLogo({ className, style }: Props) {
