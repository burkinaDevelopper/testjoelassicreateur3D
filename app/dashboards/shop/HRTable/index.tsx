...
export function HRTable({ shops }: any) {
  ...
  const tableData = useMemo(() => shops, [shops]);
  ...
  useDidUpdate(() => table.resetRowSelection(), [shops?.length]);
                        ...
                        <Collapse in={row.getIsExpanded()}>
                          {(() => {
                            if (row.getIsExpanded())
                              expandedRowIds.current.add(row.id);
