...
const TOP_LINKS = [
  { label: "APRENDE A TU RITMO", href: "/cursos" },
  { label: "SOPORTE ILIMITADO", href: "/soporte" },
  { label: "CONVIERTE TUS RENDERS EN REALIDAD", href: "/cursos", featured: true },
  { label: "APRENDE A TU RITMO", href: "/cursos", cta: true },
];
    ...
    <header className="bg-[#0E0E0E] sticky top-0 z-50 border-b border-zinc-800">
      ...
      <nav className="max-w-screen-xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          {/* Search */}
          <button className="text-zinc-400 hover:text-white p-1.5 transition-colors" aria-label="Buscar">
          ...
          {/* Cart */}
          <button className="relative text-zinc-400 hover:text-white p-1.5 transition-colors" aria-label="Carrito">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* User */}
          <button onClick={routeLogin} className="hidden lg:flex text-zinc-400 hover:text-white p-1.5 transition-colors" aria-label="Mi cuenta">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
