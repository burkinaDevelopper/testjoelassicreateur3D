...
export default function Appearance() {
  ...
  useDidUpdate(() => {
    ...
    if (currentPosition) {
      toast("Position mise à jour", {
        description: `Position des notifications mise à jour : ${currentPosition.label}`,
  ...
  useDidUpdate(() => {
    for (let i = 0; i < 3; i++) toast("Ceci est une notification");
  }, [theme.notification?.isExpanded]);

  return (
    <div className="transition-content w-full px-(--margin-x) py-6">
        <div className="mx-auto w-full max-w-3xl rounded-xl border border-gray-200 p-5 dark:border-dark-500 2xl:max-w-5xl ">
            <h5 className="dark:text-dark-50 text-lg font-medium text-gray-800">
                Apparence
            </h5>
            <p className="dark:text-dark-200 mt-0.5 text-sm text-balance text-gray-500">
                Personnalisez l'apparence de l'application. Sélectionnez les couleurs et le mode du thème
                pour changer le style de l'application.
            </p>
            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <p className="mt-0.5">
                    Vous pouvez sélectionner un thème dans la liste ci-dessous.
                    </p>
                </div>
                <RadioGroup
                ...
                <div>
                    ...
                    <p className="mt-0.5">
                    Choisissez la couleur principale de votre thème.
                    </p>
                </div>
                <RadioGroup
                    ...
                    className="mt-2"
                >
                    <Label className="sr-only">Choisir la couleur principale du thème</Label>
                ...
                <div>
                    ...
                    <p className="mt-0.5">
                    Sélectionnez la palette de couleurs claires pour votre thème.
                    </p>
                </div>
                <RadioGroup
                    ...
                    className="mt-4"
                >
                    <Label className="sr-only">Palette de couleurs du mode clair</Label>
                ...
                <div>
                    ...
                    <p className="mt-0.5">
                    Sélectionnez la palette de couleurs sombres pour votre thème.
                    </p>
                </div>
                <RadioGroup
                    ...
                    className="mt-4"
                >
                    <Label className="sr-only">Palettes de couleurs du mode sombre</Label>
                    <div className="mt-2 flex flex-wrap gap-4">
            ...
            <div>
                ...
                <p className="mt-0.5">
                    Choisissez la position et le style de regroupement des notifications
                </p>
                </div>
                <div className="mt-3">
                <p>Style de regroupement des notifications</p>
                <RadioGroup
                    value={theme.notification?.isExpanded ? "expand" : "stack"}
                    onChange={(val) => theme.setNotificationExpand(val === "expand")}
                    className="mt-3 text-center"
                >
                    <Label className="sr-only">Style de regroupement des notifications</Label>
                ...
                <div className="mt-4">
                <p>Nombre maximum de notifications</p>
                <RadioGroup
                    value={theme.notification?.visibleToasts}
                    onChange={(val) => theme.setNotificationMaxCount(val)}
                    className="mt-3 text-center"
                >
                    <Label className="sr-only">Nombre maximum de notifications</Label>
                ...
                <p className="my-auto">Position des notifications :</p>
                <Listbox
                    classNames={{
            ...
            <div className="space-y-5">
                ...
                <p className="my-auto">Style des cartes :</p>
                <Listbox
                    classNames={{
                    root: "mt-1.5 flex-1 md:col-span-2 md:mt-0",
                    }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3">
                <p className="my-auto">Mode monochrome :</p>
                <div className="dark:border-dark-450 mt-1.5 flex flex-1 items-center justify-between space-x-2 rounded-lg border border-gray-300 px-3 py-2 md:col-span-2 md:mt-0">
                    <p className="dark:text-dark-100 text-gray-800">Mode monochrome</p>
                    <Switch
